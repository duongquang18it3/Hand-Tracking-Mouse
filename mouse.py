...
#Hàm kiểm tra có phải ở chế độ click hay không
...
#Hàm kiểm tra có phải ở chế độ cuộn chuột hay không
...
#Hàm kiểm tra có phải ở chế độ di chuyển chuột hay không
...
while True:
    ...
    #Kiểm tra xem có landmarks (hay bàn tay) ở trong frame hay không
    if(landmarks != None):
        #Move mode
        ...
        #Click mode
            ...
            if(clickPoint >= point1 and clickPoint <= point2):
                ...
                if (handTracking.isRaiseFinger(landmarks, 'CHUOTTRAI') == False and handTracking.isRaiseFinger(
                        landmarks, 'CHUOTPHAI') == True):
                    print('left mouse clicked')
                    mouse.click(Button.left, 1)
                    sleep(0.25)
                elif (handTracking.isRaiseFinger(landmarks, 'CHUOTPHAI') == False and handTracking.isRaiseFinger(
                        landmarks, 'CHUOTTRAI') == True):
